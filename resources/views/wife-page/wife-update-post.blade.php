@extends('../layouts/wife-layout', ['title' => 'Post updating'])
...
<div class="breadcrumb-option">
    ...
    <section class="checkout spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h6 class="coupon__link"><span class="icon_tag_alt"></span> <a href="#">Modification du post</a> Remplissez le formulaire ci-dessous puis validez.</h6>
                </div>
                <p></p>
            </div>
            <form action="./<?= $data[0]->id ?>" method="POST" class="checkout__form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="checkout__form__input">
                                        ...
                                        <textarea cols="36" name="description">
